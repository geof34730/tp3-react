  ...
  return (
    <article className="text-white mb-4 rounded bg-secondary p-3">
      ...
      {is_answer_shown && (
        ...
        {props.editMode && (
        <div className="flex bg-light p-1 align-content-center">
            ...
            <button className="btn btn-outline-danger m-1 " onClick={() => { onClicDeleteCard(props.index_column, props.index_card) }} >
