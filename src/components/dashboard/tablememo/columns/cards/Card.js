...
const Card = (props) => {
  const onClicDeleteCard = useContext(CardContext).handleClickDeleteCard;
    ...
    <article className="text-white mb-4 rounded bg-secondary p-3">
      ...
      {is_answer_shown && (
        ...
        <div className="flex bg-light p-1 align-content-center">
            <button type="button"  className="btn btn-outline-success" onClick={() => {props.onClickEditTermem(props.indexTerm)}}>
