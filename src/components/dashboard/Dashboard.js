...
const Dashboard = () => {
    ...
    class handleContext {
        ...
        static handleClickCloseModalTerm = (e) => {
            if(e) {
                e.preventDefault();
            }
            setShowModalTerm(false);
        ...
        static handleClickEditCard = (index_column,index_card) => {
            ...
            setNumColumnAddCard(index_column);
            setCardEdit(columns_copy[index_column].cartes[index_card])
            setShowModalCard(true)
        }
        static handleClickShowModalAddCard(e,numColumn){
            setCardEdit(null)
            handleContext.handleClickShowModalCard(numColumn)
        }
        static handleClickShowModalCard = (numColumn) => {
            console.log('handleClickShowModalCard');
            setNumColumnAddCard(numColumn);
            setShowModalCard(true);
        }
        static handleClickCloseModalCard = (e) => {
            if(e) {
                e.preventDefault();
            }
