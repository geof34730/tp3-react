...
const Term = (props) => {
  ...
  return (
      <div className="d-flex btn-group"  role="group" aria-label="Basic example" >
          ...
          {props.editMode && (
              <button type="button"  className="btn btn-outline-success" onClick={() => {props.onClickEditTerm(props.indexTerm)}}>
          ...
          {props.editMode && (
                <button type="button" className="btn btn-outline-danger" onClick={() => {props.onClickDeleteTerm(props.indexTerm)}}>
